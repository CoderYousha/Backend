...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'doctor-auth' => \App\Http\Middleware\DoctorAuthentication::class,
        'employee-auth' => \App\Http\Middleware\EmployeeAuthentication::class,
        'advertisement-auth' => \App\Http\Middleware\AdvertisementAuthentication::class,
        'reception-auth' => \App\Http\Middleware\ReceptionAuthentication::class,
